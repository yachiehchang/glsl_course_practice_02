...
void main() {
   ...
   float value=mouseEffect(nuv,mouse,0.08);
  ...
  vec4 c;      
     ...
     vec4 inkColor = vec4(1.0, 0.4, 0.0, 1.0);
     vec4 src = mix( mix( inkColor, vec4(1.0, 0.9059, 0.7961, 1.0), c.r ), c, .5 );
